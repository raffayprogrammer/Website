  ...
  return (
    <section className="py-20 bg-cyan">
      <div className="max-w-4xl mx-auto px-4 text-center">
        <h2 className="text-4xl font-bold text-white font-[family-name:var(--font-poppins)] mb-4 leading-tight">
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          <Link
            href="/free-audit"
            className="bg-white text-cyan font-bold px-8 py-4 rounded-xl hover:bg-gray-50 transition-colors text-base shadow-lg"
          >
